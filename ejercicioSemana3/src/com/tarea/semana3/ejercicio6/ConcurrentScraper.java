package com.tarea.semana3.ejercicio6;
...
public class ConcurrentScraper {
    ...
    public List<PageResult> fetchWithTimeout(
            List<String> urls,
            long timeoutMs
    ) {
        List<CompletableFuture<PageResult>> futures = urls.stream()
    ...
    public void printReport(List<PageResult> results) {
        ...
        System.out.printf(
                "%nTiempo promedio: %.0fms%n",
                avg
        );

        results.stream()
                .min(Comparator.comparingLong(
                        PageResult::responseTimeMs
                ))
                .ifPresent(page ->
                        System.out.println("Mas rapida: " + page)
                );
        ...
        results.stream()
                ...
                .ifPresent(page ->
                        System.out.println("Mas lenta: " + page)
                );
